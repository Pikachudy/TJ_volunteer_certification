<template>
    <view class="page_field">
      <image
        class="image"
        mode="widthFix"
        src="https://commleague2023-1311667620.cos.ap-shanghai.myqcloud.com/redhat_2022fall_background.PNG"
      ></image>
  ...
  export default {
    ...
    methods: {
      submit() {
        ...
        .get('https://xinyufang09.site/certification/redhat2022fall',{
          params:{
            name: this.name,
