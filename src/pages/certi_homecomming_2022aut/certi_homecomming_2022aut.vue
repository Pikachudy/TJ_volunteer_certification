<template>
  <view class="page_field" style="background-color: #f2f2f2;height: 100vh;">
    <canvas canvas-id="myCanvas" style="width: 100%; height: 1050rpx" />
    <!-- <div>1111</div> -->
    <!-- <div class="btn">
    ...
    <view class="mine_button">
      <AtButton type="primary" @click="clickSaveImg" style="width: 90%;margin-top: 10%;"
        >保存至相册</AtButton
      >
    </view>
  </view>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      scale: 1,
      backImage:
        "https://636c-cloud1-7gs40qcu242746b1-1311667620.tcb.qcloud.la/pic/red_hat_2022aut_certificate.png?sign=548266b303147853bb99209bc7b0e193&t=1663678366", //背景图
      tempFilePath: "",
      name: "用户昵称", //用户昵称
          ...
          Taro.getImageInfo({
            ...
            success: function (res) {
              ...
              context.fillText(
                name,
                0.3 * windowW,
                0.42 * res.height * (windowW / res.width)
              );
